 ...
 */
#ifndef CTBNRLE_EXACTMARKOVFBINF_H
#define CTBNRLE_EXACTMARKOVFBINF_H
...
class ExactMarkovFBInf : public FBInf {
public:
	ExactMarkovFBInf();
	virtual ~ExactMarkovFBInf() throw();

	virtual ExactMarkovFBInf * Clone() const;
